...
Para transmitir los conceptos de la materia hemos elegido utilizar dos lenguajes: [Kotlin](https://kotlinlang.org/), y el objetivo principal de esta primera clase es que te familiarices con Kotlin.
...
* el tipo `Int` (Kotlin) para los números enteros, con los cuales se puede sumar, restar, multiplicar...
* el tipo `String` (Kotlin) para las cadenas de texto, las cuales se pueden pasar a mayúsculas, recortar, consultar su longitud...
